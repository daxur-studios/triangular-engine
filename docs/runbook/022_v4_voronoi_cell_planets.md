...
- State: In progress — **M0 (graph core), M1 (tectonics), and M2 (climate/biomes/rivers/coastlines) implemented**, isolated POC, not integrated with existing terrain/CDLOD; M1 and M2 are wired into the `/cell-planet-lab` lab page's 2D unwrap view as color modes, as an early visual gut-check ahead of the M3 debug lab proper
- Date: 2026-08-26
