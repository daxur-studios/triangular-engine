...
- State: In progress — **M0 (graph core) implemented**, isolated POC, not integrated with existing terrain/CDLOD
- Date: 2026-08-26
...
- **M1 — Tectonics & continents**: plates, boundary classification, land/water, elevation. Tests: ridge cells form connected chains along convergent boundaries; sea-level % within tolerance; determinism per seed.
