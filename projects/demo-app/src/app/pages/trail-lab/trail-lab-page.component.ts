...
export class TrailLabPageComponent {
  ...
  constructor() {
    ...
    const groundGeometry = new PlaneGeometry(GROUND_SIZE_M, GROUND_SIZE_M, 1, 1);
    groundGeometry.rotateX(-Math.PI / 2);
    this.groundMesh = new Mesh(groundGeometry, this.groundMaterial);
  ...
  private onMouseDown(event: MouseEvent | null): void {
    ...
    this.activeTrailPoints = [
      { positionM: hit.positionM, widthM: TRACK_WIDTH_M, alpha01: 1 },
    ];
  }
  ...
  private raycastGround(
    event: MouseEvent,
  ): { positionM: Vector3Tuple; normal: Vector3Tuple } | undefined {
