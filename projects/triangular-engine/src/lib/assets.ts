...
export const IMAGES = {
  ...
  bluenoise: `${ASSET_BASE_PATH}/images/bluenoise.png`,
  joystickBackground: `${ASSET_BASE_PATH}/images/joystickBackground.png`,
  joystickHandle: `${ASSET_BASE_PATH}/images/joystickHandle.png`,
